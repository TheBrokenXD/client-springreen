        ...
        <>
            <div className="container">
                <div className="mt-8">
                    ...
                    <p className="custom-color fw-md font-xl-4 pt-1">Mobile Application</p>
                    <p className="custom-sub-text pt-1">A lot of dealings/work can be achived with our mobile applications.</p>
                
                    <div className="mt-6">
                        <div className="card custom-on-main-bg p-3">
                            <p className="text-center font-xl fw-bold custom-color">Why should you choose us as your app builder?</p>

                            <div className="mt-4 text-center">
                                <p className="custom-text fw-md font-lg">We are the only app builder that provides you with free UI/UX development for your context.</p>
                                <p className="custom-text fw-md font-lg">We offer free release of Multi-Signed Applications.</p>
                                <p className="custom-text fw-md font-lg">We provide free multi-OS support.</p>
                                <p className="custom-text fw-md font-lg">On an On-Demand Basis, We Provide a Specific OS-Based App.</p>
                                <p className="custom-text fw-md font-lg">{`We provide free 99.99% Uptime Guaranteed for your app's backend.`}</p>
                                <p className="custom-text fw-md font-lg">Get six months of free backend hosting.</p>
                                <p className="custom-text fw-md font-lg">We provide you with a free 10-day money-back guarantee.</p>
                                <p className="custom-text fw-md font-lg">We provide you with a free five-day return policy.</p>
                                <p className="custom-text fw-md font-lg">We provide you with free first-time setup and installation.</p>
                            </div>
                        </div>
