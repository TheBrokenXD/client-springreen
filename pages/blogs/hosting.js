        ...
        <>
            <div className="container">
                <div className="mt-8">
                    ...
                    <p className="custom-color fw-md font-xl-4 pt-1">Host-Maniac</p>    
                    <p className="custom-sub-text pt-1">Using cloud computing we can provide you fast and efficient services.</p>
                
                    <div className="mt-6">
                        <div className="card custom-on-main-bg p-3">
                            <p className="text-center font-xl fw-bold custom-color">Why should you choose our host-maniac?</p>
                            <div className="mt-4 text-center">
                                ...
                                <p className="custom-text fw-md font-lg">Upload, Manage, Host Anytime Anywhere, with our Dashboard.</p>
                                <p className="custom-text fw-md font-lg">Unlike Heroku, We allow users to manage their own data, and host it on our servers.</p>
                                <p className="custom-text fw-md font-lg">All of The Above mentioned is free forever.</p>
                                <p className="custom-text fw-md font-lg">We provide our own Packages for your code-build, and you can deploy it on our servers with a single click.</p>
                                <p className="custom-text fw-md font-lg">We provide CLI, DataBases, Loggers, Desktop App, Mobile App.</p>
                            </div>
                        </div>
